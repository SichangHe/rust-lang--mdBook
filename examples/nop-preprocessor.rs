...
fn handle_preprocessing(pre: &dyn Preprocessor) -> Result<(), Error> {
    ...
    let version_req = VersionReq::parse(mdbook_fork4ls::MDBOOK_VERSION)?;
...
mod nop_lib {
    ...
    mod test {
        ...
        fn nop_preprocessor_run() {
            ...
            let (ctx, book) =
                mdbook_fork4ls::preprocess::CmdPreprocessor::parse_input(input_json).unwrap();
