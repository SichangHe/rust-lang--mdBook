...
[TIMESTAMP] [INFO] (mdbook_fork4ls::book): Testing chapter 'Intro': "intro.md"
[TIMESTAMP] [INFO] (mdbook_fork4ls::book): Testing chapter 'Passing 1': "passing1.md"
[TIMESTAMP] [INFO] (mdbook_fork4ls::book): Testing chapter 'Passing 2': "passing2.md"
...
fn failing_tests() {
    BookTest::from_dir("test/failing_tests").run("test", |cmd| {
        cmd.expect_code(101)
            ...
            // add more redactions.
            .expect_stderr(str![[r#"
[TIMESTAMP] [INFO] (mdbook_fork4ls::book): Testing chapter 'Failing Tests': "failing.md"
[TIMESTAMP] [ERROR] (mdbook_fork4ls::book): rustdoc returned an error:
...
fail
...
[TIMESTAMP] [INFO] (mdbook_fork4ls::book): Testing chapter 'Failing Include': "failing_include.md"
[TIMESTAMP] [ERROR] (mdbook_fork4ls::book): rustdoc returned an error:
...
failing!
...
[TIMESTAMP] [ERROR] (mdbook_fork4ls::utils): Error: One or more tests failed
...
fn chapter_not_found() {
    BookTest::from_dir("test/passing_tests").run("test -c bogus", |cmd| {
        cmd.expect_failure()
            .expect_stdout(str![[""]])
            .expect_stderr(str![[r#"
[TIMESTAMP] [ERROR] (mdbook_fork4ls::utils): Error: Chapter not found: bogus
